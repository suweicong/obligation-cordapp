...
object TransferObligation {
    ...
    class Initiator(private val linearId: UniqueIdentifier,
        ...
        override fun call(): SignedTransaction {
            ...
            val transferCommand = Command(ObligationContractV2.Commands.Transfer(), signerKeys)
        ...
        @Suspendable
        private fun getLenderIdentity(inputObligation: ObligationV2): AbstractParty {
        ...
        @Suspendable
        private fun createOutputObligation(inputObligation: ObligationV2): ObligationV2 {
            return if (anonymous) {
        ...
        @Suspendable
        private fun getBorrowerIdentity(inputObligation: ObligationV2): Party {
